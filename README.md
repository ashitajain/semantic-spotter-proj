...
- Clone the github repository
  ```shell
  $ git clone https://github.com/ashitajain/semantic-spotter-proj.git
  ```
- Open
  the [notebook](https://github.com/ashitajain/semantic-spotter-proj/blob/main/Ashita-Jain-semantic-spotter/semantic-spotter-langchain-notebook.ipynb)
